// AppShell server-component layout for the authenticated client portal.
// Performs the auth + role + onboarding guard at the layout level so every
// nested route inherits the same protection. Per CLAUDE.md: client UI must
// never render supplier real_name. This layout makes the user available to
// nested pages via React props are not great for layouts; we use a
// per-page getCurrentUser call instead and just render the shell here.
  ...
  return (
    <aside className="hidden w-56 shrink-0 lg:block">
      <NavGroup label="Main">
        ...
        <NavLink href="/catalog">Browse Catalog</NavLink>
        <NavLink href="/rfqs">RFQs</NavLink>
        <NavLink href="/orders">Orders</NavLink>
      </NavGroup>
      <NavGroup label="Management">
        <NavLink href="/cart">RFQ Basket</NavLink>
        <NavLink href="/cart/saved">Saved Carts</NavLink>
        <NavLink href="/favourites">Favourites</NavLink>
        <NavLink href="/catalogs">Company Catalogs</NavLink>
        <NavLink href="/catalog/bundles">Bundles</NavLink>
      </NavGroup>
      <NavGroup label="Account">
        <NavLink href="/account/users">Account Management</NavLink>
